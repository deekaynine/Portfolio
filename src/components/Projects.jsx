...
const Projects = () => {
  return (
    <div
      name="projects"
      className="w-full md:h-screen bg-[#0f0f0f] text-gray-300"
    >
      <div className="max-w-[1000] mx-auto p-4 flex flex-col justify-center w-[90%] h-full">
        ...
        {/*Project Catalog*/}
        <div className="sm:grid sm:grid-cols-2 md:grid md:grid-cols-3 gap-4">
          {/*Project item 1*/}
          <div
            style={{
          ...
          <div
            ...
            className="mb-4 shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto col-start-2 content-div"
          >
            {/*Hover Effects*/}
            <div className="opacity-0 group-hover:opacity-100 duration-1000">
              <span className="text-2xl font-bold text-white tracking-wider">
